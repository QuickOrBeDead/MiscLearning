...
diff.Reverse();
Console.WriteLine("S1:{0}{1}{0}", Environment.NewLine, string.Join(Environment.NewLine, s1));
Console.WriteLine("S2:{0}{1}{0}", Environment.NewLine, string.Join(Environment.NewLine, s2));
